          ...
          <div className={`fixed w-full top-0 z-50 transition duration-300 
            ...
            <div className="flex flex-wrap items-center justify-between px-4 md:px-6 py-3">
              ...
              <div className="flex items-center gap-2 md:gap-4 ml-auto">
                <button className={`text-xs sm:text-sm md:text-base ${Scrolled ? 'text-black' : 'text-white'} hover:text-orange-300 transition duration-300`}>
                  Explore
                </button>
                <button className={`flex items-center gap-1 text-xs sm:text-sm md:text-base uppercase font-semibold px-2 md:px-3 py-1 md:py-2 rounded 
                  ${Scrolled ? 'ring ring-black text-black' : 'ring ring-white text-white'} hover:bg-orange-300 hover:text-black transition duration-200`}>
                  Buy a Property
                </button>
                <button className={`flex items-center gap-1 text-xs sm:text-sm md:text-base uppercase font-semibold px-2 md:px-3 py-1 md:py-2 rounded 
                  ${Scrolled ? 'ring ring-black text-black' : 'ring ring-white text-white'} hover:bg-orange-300 hover:text-black transition duration-200`}>
                ...
                <button>
                  <CiBellOn className={`h-6 w-6 sm:h-8 sm:w-8 cursor-pointer hover:text-orange-300 transition duration-300 ${Scrolled ? 'text-black' : 'text-white'}`} />
                </button>
                <button onClick={() => setIsSignupVisible(true)}>
                  <FaUserCircle className={`h-6 w-6 sm:h-8 sm:w-8 cursor-pointer hover:text-orange-300 transition duration-300 ${Scrolled ? 'text-black' : 'text-white'}`} />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className={`fixed w-full top-0 z-50 transition duration-300 
            ...
            <div className="flex flex-wrap items-center justify-between px-4 py-3">
              ...
              <div className="flex items-center gap-3">
                <button className={`flex items-center gap-1 text-xs ${Scrolled ? 'text-black' : 'text-white'} hover:text-orange-300 transition`}>
                ...
                <button onClick={() => setIsSignupVisible(true)} className={`flex items-center gap-1 text-xs ${Scrolled ? 'text-black' : 'text-white'} hover:text-orange-300 transition`}>
